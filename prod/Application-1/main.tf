...
module "prod_alb" {
  source           = "github.com/ppeuming/Terraform_Project_LocalModule//aws-alb?ref=v1.0.0" # local module의 경로
...
module "prod_asg" {
  source           = "github.com/ppeuming/Terraform_Project_LocalModule//aws-asg?ref=v1.0.0" # local module의 경로
  name             = "prod"                  # variables 설정
