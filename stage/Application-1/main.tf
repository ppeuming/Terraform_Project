...
module "stage_alb" {
  source           = "github.com/ppeuming/Terraform_Project_LocalModule//aws-alb?ref=v1.0.0" # git hub tag
...
module "stage_asg" {
  source           = "github.com/ppeuming/Terraform_Project_LocalModule//aws-asg?ref=v1.0.0" # git hub tag
  name             = "stage"                 # variables 설정
